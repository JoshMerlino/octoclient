	...
	return (
		<footer id="footer">
			<div className="bg-header">
				...
				<div className="w-full text-gray-300 font-medium bg-black/10 min-h-[48px] flex items-center font-manrope leading-none">
					<div className="mx-auto max-w-full md:max-w-[80%] w-[1280px] px-12 z-[4]">
